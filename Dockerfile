...
COPY --from=builder /app/target/race_application_cs-0.0.1-SNAPSHOT.jar ./race_application_cs-0.0.1-SNAPSHOT.jar

EXPOSE 8080

CMD ["java", "-jar", "race_application_cs-0.0.1-SNAPSHOT.jar"]
