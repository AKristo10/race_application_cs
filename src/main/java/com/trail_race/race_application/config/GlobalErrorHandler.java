...
public class GlobalErrorHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorizedExceptions(HttpServletRequest req, Exception e) {
        return getAndLogDebug(req, e, HttpStatus.UNAUTHORIZED);
    }
    ...
    public ResponseEntity<ErrorResponse> handleForbiddenExceptions(HttpServletRequest req, Exception e) {
        return getAndLogDebug(req, e, HttpStatus.FORBIDDEN);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGenericExceptions(HttpServletRequest req, Exception e) {
        ...
        if (e instanceof UndeclaredThrowableException
                && isThrowableOrCauseInstanceOf(e.getCause(), UnauthorizedException.class)) {
            return handleUnauthorizedExceptions(req, e);
        }
